...
enum WorldFloatConfigs : uint32
{
    ...
    CONFIG_DYN_RESPAWN_MAX_REDUCTION_RATE,
    CONFIG_DYN_RESPAWN_PERCENT_PER_PLAYER,
...
enum WorldIntConfigs : uint32
{
    ...
    CONFIG_DYN_RESPAWN_MIN_RESPAWN_TIME,
    CONFIG_DYN_RESPAWN_MIN_RESPAWN_TIME_INDOORS,
    CONFIG_DYN_RESPAWN_AFFECT_RESPAWN_TIME_BELOW,
    CONFIG_DYN_RESPAWN_AFFECT_LEVEL_BELOW,
