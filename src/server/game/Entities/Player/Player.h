...
class TC_GAME_API Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        void LearnSpell(uint32 spell_id, bool dependent, uint32 fromSkill = 0, bool announce = true);
        void RemoveSpell(uint32 spell_id, bool disabled = false, bool learn_low_rank = true, bool announce = true);
